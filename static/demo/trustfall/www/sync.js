export class SyncContext {
    constructor({ ctrlBuffer, contentBuffer }) {
...
SyncContext.CTRL_BUFFER_LENGTH = 12;
SyncContext.CONTENT_BUFFER_LENGTH = 4096;
SyncContext.CTRL_OFFSET_STATE = 0;
SyncContext.CTRL_OFFSET_CURRENT_WRITE_SIZE = 1;
SyncContext.CTRL_OFFSET_TOTAL_SIZE = 2;
SyncContext.STATE_WAITING_FOR_DATA = 128;
SyncContext.STATE_DONE = 1;
SyncContext.STATE_BUFFER_FULL = 2;
SyncContext.STATE_TERMINATED_ERROR = 3;
