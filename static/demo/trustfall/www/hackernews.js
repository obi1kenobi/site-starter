...
export function materializeItem(fetchPort, itemId) {
...
export function materializeUser(fetchPort, username) {
    const sync = SyncContext.makeDefault();
...
export function* getTopItems(fetchPort) {
    const sync = SyncContext.makeDefault();
...
export function* getLatestItems(fetchPort) {
    const sync = SyncContext.makeDefault();
